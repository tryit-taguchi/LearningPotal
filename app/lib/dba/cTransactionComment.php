<?PHP
/**
 * T_COMMENT情報クラス(静的クラス)
 *
 * T_COMMENTに関わる機能を提供するクラス
 *
 * @access public
...
/**
 */
class cTransactionComment extends cDbaDefault
{
	const TABLE_NAME  = "T_COMMENT";     // 対応するテーブル名
	const PRIMARY_KEY = "COMMENT_ID";    // 対応するプライマリーキー
