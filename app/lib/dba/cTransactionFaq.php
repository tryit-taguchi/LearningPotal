...
/**
 */
class cTransactionFaq extends cDbaDefault
{
	const TABLE_NAME  = "T_FAQ";     // 対応するテーブル名
	const PRIMARY_KEY = "FAQ_ID";    // 対応するプライマリーキー
	...
	static public function getWhere($search = array()) {
		...
		parent::setSimpleCond($where,$cond,$search,"FAQ_CAT");
		parent::setSimpleCond($where,$cond,$search,"FAQ_PID");
		parent::setSimpleCond($where,$cond,$search,"FAQ_TYPE");
		parent::setSimpleCond($where,$cond,$search,"FAQ_FLG");
