<?PHP
/**
 * M_QUESTION_ATR情報クラス(静的クラス)
 *
 * M_QUESTION_ATRに関わる機能を提供するクラス
 *
 * @access public
...
/**
 */
class cMasterQuestionAtr extends cDbaDefault
{
	const TABLE_NAME  = "M_QUESTION_ATR";  // 対応するテーブル名
	const PRIMARY_KEY = "QUESTION_ATR_ID"; // 対応するプライマリーキー
	...
	static public function getWhere($search = array()) {
		...
		parent::setSimpleCond($where,$cond,$search,"QUESTION_DIV");
