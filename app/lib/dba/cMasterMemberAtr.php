<?PHP
/**
 * M_MEMBER_ATR情報クラス(静的クラス)
 *
 * M_MEMBER_ATRに関わる機能を提供するクラス
 *
 * @access public
...
/**
 */
class cMasterMemberAtr extends cDbaDefault
{
	const TABLE_NAME  = "M_MEMBER_ATR";  // 対応するテーブル名
	const PRIMARY_KEY = "MEMBER_ATR_ID"; // 対応するプライマリーキー
	...
	static public function setData($data) {
		...
		$cond['SITE_NAME']     = $data['SITE_NAME']; // 受講者属性
